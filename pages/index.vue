<template>
  <div class="container">
    ...
    <!-- Code Editors -->
    <CodeEditor v-if="currentTab === 'html'" type="html" />
    <CodeEditor v-if="currentTab === 'css'" type="css" />
    <CodeEditor v-if="currentTab === 'js'" type="js" />
    <CodeEditor v-if="currentTab === 'json'" type="json" />
